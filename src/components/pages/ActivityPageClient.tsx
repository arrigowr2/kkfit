        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
          ...
          <div className="relative">
            ...
            {showDatePicker && (
              <div
                ref={datePickerRef}
                className="absolute left-0 sm:left-auto right-0 sm:right-0 top-full mt-2 bg-slate-800 border border-slate-700 rounded-xl p-4 shadow-xl z-50 w-[calc(100vw-2rem)] sm:w-auto sm:min-w-[280px] max-w-[320px] overflow-hidden"
              >
                <input
                  type="date"
